...
const CHANNEL_INFO = {
  ...
  tagline:
    "Бывший CMO Ultimate Guitar и COO Яндекса с командой 60+ человек и миллиардными маркетинговыми бюджетами. Также, создател...",
  subscribers: 353,
  avatarUrl:
    "https://cdn.poehali.dev/files/e8c5aca1-e954-401a-bb79-620656139ed2.jpg",
};

const POSTS_API =
  "https://functions.poehali.dev/db373ce5-74a9-4e99-8495-f473299be4e2";
      ...
      <div className="w-full max-w-6xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:flex lg:flex-col">
            <Card className="bg-[#2d2d2d] border-0 rounded-3xl overflow-hidden shadow-2xl relative lg:h-full lg:min-h-[390px] flex flex-col">
                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        {!isLoaded ? (
                          ...
                          <>
                            ...
                            <div
                              className="flex items-center justify-between pt-3 animate-in fade-in duration-500"
